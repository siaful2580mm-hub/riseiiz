    ...
    <div className="space-y-6 animate-in fade-in duration-700 pb-10">
      ...
      <div className="flex gap-3">
        <div className="flex-1 glass-dark border-emerald-500/20 p-4 rounded-3xl flex flex-col justify-between h-28 relative overflow-hidden group">
          <div className="flex justify-between items-start z-10">
            <div className="w-8 h-8 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-400"><TrendingUp size={16} /></div>
            <div className="flex items-center gap-1"><div className="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse"></div><span className="text-[7px] font-black text-emerald-500 uppercase tracking-widest">LIVE</span></div>
          </div>
          <div className="z-10">
        ...
        <div className="flex-1 glass-dark border-blue-500/20 p-4 rounded-3xl flex flex-col justify-between h-28 relative overflow-hidden group">
          <div className="flex justify-between items-start z-10">
            <div className="w-8 h-8 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-400"><Users size={16} /></div>
          </div>
          <div className="z-10">
      ...
      {settings?.notice_text && (
        <Link to={settings.notice_link || '/notice'} className="block">
          <div className="bg-gradient-to-r from-[#00f2ff]/20 to-[#7b61ff]/20 border border-white/5 rounded-2xl p-4 flex items-center gap-4 group active:scale-[0.98] transition-all">
            <div className="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center text-[#00f2ff] group-hover:rotate-12 transition-transform"><Megaphone size={20} /></div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <GlassCard className="bg-gradient-to-br from-[#00f2ff]/10 to-transparent border-[#00f2ff]/20">
          <span className="text-[10px] text-slate-500 uppercase tracking-widest font-black mb-1 block">Your Balance</span>
      ...
      <div className="bg-white/5 border border-white/5 rounded-2xl p-3 flex items-center justify-between">
         <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-amber-500/10 rounded-lg flex items-center justify-center text-amber-500"><Gift size={16} /></div>
            <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Join Bonus Received: ৳১০</p>
         </div>
      ...
      <section className="space-y-4">
        <div className="flex justify-between items-center px-1">
          <h3 className="text-sm font-black uppercase tracking-widest flex items-center gap-2">
            <CheckSquare className="text-[#00f2ff]" size={18} /> Daily Missions
          </h3>
      ...
      <div className="flex gap-4 overflow-x-auto scrollbar-hide py-2">
         ...
         <a href={settings?.support_url} target="_blank" className="min-w-[120px] glass-dark border-white/5 p-4 rounded-2xl text-center space-y-2 group active:scale-95 transition-all">
            ...
            <p className="text-[9px] font-black uppercase text-slate-400">Video Guide</p>
         </a>
         <Link to="/wallet" className="min-w-[120px] glass-dark border-white/5 p-4 rounded-2xl text-center space-y-2 group active:scale-95 transition-all">
            <div className="w-10 h-10 bg-emerald-500/10 text-emerald-400 rounded-full flex items-center justify-center mx-auto group-hover:bg-emerald-500 group-hover:text-slate-950 transition-all"><Wallet size={20} /></div>
            <p className="text-[9px] font-black uppercase text-slate-400">Cash Out</p>
         </Link>
      </div>
    </div>
  );
